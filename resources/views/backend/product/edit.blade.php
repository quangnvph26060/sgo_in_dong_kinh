                    ...
                    <div class="card-body">
                        <div class="row form-group">
                            ...
                            <div class="mb-3 col-lg-6 position-relative">
                                ...
                                <input value="{{ $product->slug }}" type="text" class="form-control" name="slug"
                                    id="slug" placeholder="Nhập slug">
                            </div>

                            <div class="mb-3 col-lg-6 position-relative">
                                <label for="short_name" class="form-label fw-bold">Tên ngắn</label>
                                <input value="{{ $product->short_name }}" type="text" class="form-control"
                                    name="short_name" id="short_name" placeholder="Nhập tên ngắn">
                            </div>

                            <!-- Giá -->
                            <div class="mb-3 col-lg-6">
                                <label for="price" class="form-label fw-bold">Giá</label>
                                <input value="{{ number_format($product->price, 0, ',', '.') }}" type="text"
                                    class="form-control money-input" name="price" id="price"
                                    placeholder="Nhập giá sản phẩm">
                            </div>

                            <div class="mb-3 col-lg-6">
                                <label for="price" class="form-label fw-bold">Giá khuyến mãi</label>
                                <input value="{{ number_format($product->sale_price, 0, ',', '.') }}" type="text"
                                    class="form-control money-input" name="sale_price" id="sale_price"
                            ...
                            <div class="mb-3 col-lg-6">
                                ...
                                <input value="{{ $product->view_count }}" type="number" class="form-control"
                            ...
                            <div class="col-lg-12 mb-3 position-relative">
                                ...
                                <textarea id="short_description" class="form-control" name="short_description" rows="4">{{ $product->short_description }}</textarea>
                            </div>

                            <div class="col-lg-12">
                                <label for="description" class="form-label fw-bold">Mô tả chi tiết</label>
                                <textarea id="description" class="form-control ckeditor" name="description" rows="10">{!! $product->description !!}</textarea>
                            </div>
                    ...
                    <div class="card-body">
                        <div class="seo-box">
                            <div class="seo-preview mb-3">
                                <a href="#" class="title d-block">{{ $product->title_seo ?? $product->name }}</a>
                                <div class="url">
                                    {{ config('app.url') }}/{{ $product->category->slug }}/{{ $product->slug }}</div>
                                <div class="date mt-1">
                                    {{ $product->created_at->locale('vi')->translatedFormat('l, j \T\h\á\n\g n, Y') }} -
                                    <span
                                        class="desc">{{ $product->description_seo ? Str::words($product->description_seo, 30, '...') : 'Đang cập nhật...' }}</span>
                                </div>
                            </div>
                        ...
                        <div class="radio-container">
                            <label class="toggle">
                                <input type="checkbox" class="status-change update-status" name="is_top"
                                    @checked($product->is_top == 1) value="1">
